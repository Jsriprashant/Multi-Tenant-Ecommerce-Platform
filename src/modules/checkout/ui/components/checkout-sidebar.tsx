...
export const CheckoutSidebar = ({ totalPrice, onCheckout, isCancelled, isPending }: props) => {
    return (
        <div className="border rounded-md overflow-hidden bg-white flex flex-col" >
            ...
            {isCancelled && (
                <div className="p-4 flex justify-center items-center border-t">
                    <div className="bg-red-100 border-red-500 font-medium px-4 py-3 rounded flex items-center w-full " >
